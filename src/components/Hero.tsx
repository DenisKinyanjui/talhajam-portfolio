  ...
  return (
    ...
    >
      <div className="mx-auto grid w-full max-w-6xl items-center gap-12 lg:grid-cols-[1.15fr_0.85fr]">
        <div>
          <Reveal>
            <span className="inline-flex items-center gap-2 py-1.5 text-xs font-medium tracking-[0.18em] text-gold-soft">
              <BadgeCheck
                size={18}
        ...
        <Reveal delay={120}>
          <div className="relative mx-auto aspect-square w-full max-w-sm">
            <div className="absolute inset-0 -rotate-2 rounded-2xl border border-gold/30" />
            <img
              src="/image.jpeg"
              alt="Talha Ahmad"
...
//     <section
//       id="hero"
//       className="relative flex min-h-screen flex-col items-center justify-center border-b border-line px-6 pt-24"
//     >
//       <div className="mx-auto max-w-3xl text-center">
//         <div className="mb-6 inline-flex rounded-md border border-gray-200 bg-amber-50 px-4 py-2 text-sm font-medium text-amber-700">
...
//           Access to this website has been temporarily suspended while
//           administrative matters are being resolved. Service will be restored
//           once those matters are completed.
//         </p>

//         <div className="mt-10 rounded-lg border border-gray-200 bg-gray-50 p-6 text-left">
//           <h2 className="mb-2 text-lg font-semibold">Notice</h2>
//           <p className="text-gray-600">
//             This is a temporary service interruption. The website content has
//             not been removed and access may be restored once the outstanding
//             administrative requirements have been addressed.
//           </p>
//         </div>
//       </div>
//     </section>
